...
export default function NewPageUi() {
  ...
  async function createPage() {
    ...
    setIsCreating(true);
    try {
      // Use an existing mock as a sane template, then override title/slug.
      const template =
        getPageBySlug("consulting-session") ??
        getPageBySlug("donation") ??
        ({
      ...
      router.push(`/admin/pages/${encodeURIComponent(s)}`);
      router.refresh();
    } catch (e) {
